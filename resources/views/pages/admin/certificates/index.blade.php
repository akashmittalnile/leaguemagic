...
<div class="user-table-section">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Certificates</h4>
            </div>
            <div class="p-2">
                <a class="btn search-icon add-new-btn mx-1 shadow" href="{{route('admin.certificates.index','export=true')}}">Export cetificates</a>
            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-md-7">
                            <div class="search-form-group">
                                <form class="d-flex " class="search-form">
                                    <input type="text" name="search" class="form-control" placeholder="Search Certificates by name or status">
                                    <button class="btn search-icon bg-light mx-1 shadow " type="submit"><img src="{{asset('public/admin/images/search-icon.svg')}}"></button>
                                    <a class="btn search-icon bg-light mx-1 shadow" href="{{route('admin.certificates.index')}}"><img src="{{asset('public/admin/images/reset.png')}}" height="25"></a>
                                </form>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <a class="add-new-btn" data-bs-toggle="modal" data-bs-target="#AddConferences"> Add new Certificates</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="lm-content-section">
        <div class="lm-table-card">
            <div class="table-responsive">
                <table class="table table-lm" id="table">
                    <thead>
                        <tr>
                            <th>S.No</th>
                        ...
                        <tr>
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="">
                                        <label class="toggle" for="myToggle{{$con->id}}">
                                            <input class="toggle__input" name="" onchange="toggleStatus(this)" data-update_url="{{route('admin.certificates.update',$con->id)}}" {{$con->status?"checked":""}} type="checkbox" id="myToggle{{$con->id}}">
                            ...
                            <td style="width: 100px;">
                                <div class="table-action-info">
                                    ...
                                    <button onclick="edit(this)" data-name="{{ $con->name }}" data-group_id="{{ $con->group_id }}" data-upload_format="{{ $con->upload_format }}" data-duration="{{ $con->duration }}" data-status="{{ $con->status }}" data-update_url="{{ route('admin.certificates.update', $con->id) }}" data-bs-toggle="modal" data-bs-target="#editConferences" class="edit-btn">
                                    ...
                                    <button type="button" class="btn  btn-xs" onclick="deletePost({{$con->id}})">
                                        ...
                                        <form action="{{route('admin.certificates.destroy',$con->id)}}" method="POST" id="del-post-{{$con->id}}" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        </a>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="lm-modal-form">
                    ...
                    <form action="{{route('admin.certificates.store')}}" method="POST" enctype="multipart/form-data" id="create-form">
                        @csrf
                        <input type="hidden" name="redirect_url" id="redirect_url" value="{{ route('admin.certificates.index') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Certificates Address</label>
                                    ...
                                    <span class="form-msg-text">is this a player/coach/admin Certificates Item.</span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Certificates Expiration</label>
                                    <select name="duration" class="form-control">
                                        <option value="">--select group--</option>
                                        @foreach ([1,2,3,4,5,6,7] as $position )
                                        <option value="{{$position}}">"{{$position}} Years</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="certificate_format" placeholder="Type Here">
...
<div class="modal lm-modal fade" id="editConferences" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div class="lm-modal-form">
                    <h2>Edit Certificates Details </h2>
                    <form action="" method="POST" id="edit-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Certificates Address</label>
                                    <select name="group_id" id="edit-group_id" class="form-control">
                                        <option value="">--select group--</option>
                                        @foreach ($positions as $position )
                                        <option value="{{$position->id}}">{{$position->name}}</option>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <img id="edit-certificate_format" alt="" height="100" class="m-2 border">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button class="cancel-btn" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
                                    <button class="save-btn" type="submit">Save & updated</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    function edit(ele) {
        ...
        $("#edit-duration").val(ele.getAttribute("data-duration"));
        $("#edit-group_id").val(ele.getAttribute("data-group_id"));

        $("#edit-certificate_format").attr("src", "{{asset('public/uploads/certificates')}}" + "/" + ele.getAttribute("data-upload_format"));
