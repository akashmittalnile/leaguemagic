                ...
                <table class="table table-lm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="lm-status-text {{$con->status==1?'st-active':'st-inactive'}}">
                                    {{$con->status==1?"Active":"Inactive"}}
                                </div>
                            </td>
                            ...
                            <td style="width: 200px;">
                                <div class="switch-toggle">
                                    <p>{{$con->status==1?"Active":"Inactive"}}</p>
                                    <div class="">
                                        <label class="toggle" for="myToggle{{$con->id}}">
                                            <input class="toggle__input" name="" onchange="toggleStatus(this)" data-update_url="{{route('admin.clubs.update',$con->id)}}" {{$con->status==1?"checked":""}} type="checkbox" id="myToggle{{$con->id}}">
