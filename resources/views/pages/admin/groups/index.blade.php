...
<div class="user-table-section">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Divisions Groups</h4>
            </div>
            <div class="p-2">
                <a class="btn search-icon add-new-btn mx-1 shadow" href="{{route('admin.groups.index','export=true')}}">Export groups</a>
            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-md-7">
                            <div class="search-form-group">
                                <form class="d-flex">
                                    <input type="text" name="search" class="form-control" placeholder="Search groups by name or status">
                                    <button class="btn search-icon bg-light mx-1 shadow " type="submit"><img src="{{asset('public/admin/images/search-icon.svg')}}"></button>
                                    <a class="btn search-icon bg-light mx-1 shadow" href="{{route('admin.groups.index')}}"><img src="{{asset('public/admin/images/reset.png')}}" height="25"></a>
                        ...
                        <tr>
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="">
                                        <label class="toggle" for="myToggle{{$con->id}}">
                                            <input class="toggle__input" name="" onchange="toggleStatus(this)" data-update_url="{{route('admin.groups.update',$con->id)}}" {{$con->status?"checked":""}} type="checkbox" id="myToggle{{$con->id}}">
                            ...
                            <td style="width: 100px;">
                                <div class="table-action-info">
                                    ...
                                    <button onclick="edit(this)" data-name="{{ $con->name }}" data-sort_order="{{ $con->sort_order }}" data-short_name="{{ $con->short_name }}" data-status="{{ $con->status }}" data-update_url="{{ route('admin.groups.update', $con->id) }}" data-bs-toggle="modal" data-bs-target="#editConferences" class="edit-btn">
                                    ...
                                    <button type="button" class="btn  btn-xs" onclick="deletePost({{ $con->id }})">
                                        ...
                                        <form action="{{ route('admin.groups.destroy', $con->id) }}" method="POST" id="del-post-{{ $con->id }}" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        </a>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="lm-modal-form">
                    ...
                    <form action="{{ route('admin.groups.store') }}" method="POST" enctype="multipart/form-data" id="create-form">
                        @csrf
                        <input type="hidden" name="redirect_url" id="redirect_url" value="{{ route('admin.groups.index') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label">Group Sort Order</label>
