...
<div class="user-table-section">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Staff Management</h4>
            </div>
            <div class="p-2">
                <a class="btn search-icon add-new-btn mx-1 shadow" href="{{ route('admin.staffManagement.index', 'export=true') }}">Export staffManagement</a>
            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-md-7">
                            <div class="search-form-group">
                                <form class="d-flex">
                                    <input type="text" name="search" class="form-control" placeholder="Search staffManagement by name or status">
                                    <button class="btn search-icon bg-light mx-1 shadow " type="submit"><img src="{{ asset('public/admin/images/search-icon.svg') }}"></button>
                                    <a class="btn search-icon bg-light mx-1 shadow" href="{{ route('admin.staffManagement.index') }}"><img src="{{ asset('public/admin/images/reset.png') }}" height="25"></a>
        ...
        <div class="lm-table-card">
            <div class="table-responsive">
                <table class="table table-lm">
                    ...
                    <tbody>
                        @forelse($staffManagement as $i=>$con)
                        <tr>
                            <td>
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="">
                                        <label class="toggle" for="myToggle{{ $con->id }}">
                                            <input class="toggle__input" name="" onchange="toggleStatus(this)" data-update_url="{{ route('admin.staffManagement.update', $con->id) }}" {{ $con->status ? 'checked' : '' }} type="checkbox" id="myToggle{{ $con->id }}">
                            ...
                            <td style="width: 100px;">
                                <div class="table-action-info">
                                    ...
                                    <button onclick="edit(this)" data-first_name="{{ $con->name ? $con->name : $con->first_name }}" data-last_name="{{ $con->name ? '' : $con->last_name }}" data-email="{{ $con->email }}" data-hourly_rate="{{ $con->hourly_rate }}" data-mileage_rate="{{ $con->mileage_rate }}" data-contact_number="{{ $con->contact_number }}" data-city="{{ $con->city }}" data-state_id="{{ $con->state_id }}" data-address_line1="{{ $con->address_line1 }}" data-address_line2="{{ $con->address_line2 }}" data-zipcode="{{ $con->zipcode }}" data-update_url="{{ route('admin.staffManagement.update', $con->id) }}" data-bs-toggle="modal" data-bs-target="#editConferences" class="edit-btn">
                                    ...
                                    <button type="button" class="btn  btn-xs" onclick="deletePost({{ $con->id }})">
                                        ...
                                        <form action="{{ route('admin.staffManagement.destroy', $con->id) }}" method="POST" id="del-post-{{ $con->id }}" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        </a>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="lm-modal-form">
                    <h2>Add New User </h2>
                    <form action="{{ route('admin.staffManagement.store') }}" method="POST" enctype="multipart/form-data" id="create-form">
                        @csrf
                        <input type="hidden" name="redirect_url" id="redirect_url" value="{{ route('admin.staffManagement.index') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="passchange">
                                    <label>Staff Hourly Rate</label>
                                    <input type="text" class="form-control" name="hourly_rate" placeholder="type here">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="passchange">
                                    <label>Staff Mileage Reimbursement</label>
                                    <input type="text" class="form-control" name="mileage_rate" placeholder="type here">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <ul class="lm-Status-list">
                                        <li>
                                            <div class="lm-radio">
                                                <input type="radio" value="1" id="Active" checked name="status">
                                                <label for="Active">
                                                    Active
                                                </label>
                                            </div>
                    ...
                    <form method="POST" enctype="multipart/form-data" id="edit-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="passchange">
                                    <label>Staff Hourly Rate</label>
                                    <input type="text" class="form-control" name="hourly_rate" id="edit-hourly_rate" placeholder="type here">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="passchange">
                                    <label>Staff Mileage Reimbursement</label>
                                    <input type="text" class="form-control" name="mileage_rate" id="edit-mileage_rate" placeholder="type here">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
...
<script>
    ...
    function edit(ele) {
        ...
        $("#edit-hourly_rate").val(ele.getAttribute("data-hourly_rate"));
        $("#edit-mileage_rate").val(ele.getAttribute("data-mileage_rate"));
