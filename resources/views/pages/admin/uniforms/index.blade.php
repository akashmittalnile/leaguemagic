...
<div class="user-table-section">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Uniforms Colors</h4>
            </div>
            <div class="p-2">
                <a class="btn search-icon add-new-btn mx-1 shadow" href="{{route('admin.uniforms.index','export=true')}}">Export uniforms</a>
            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-md-7">
                            <div class="search-form-group">
                                <form class="d-flex">
                                    <input type="text" name="search" class="form-control" placeholder="Search uniforms by name or status">
                                    <button class="btn search-icon bg-light mx-1 shadow " type="submit"><img src="{{asset('public/admin/images/search-icon.svg')}}"></button>
                                    <a class="btn search-icon bg-light mx-1 shadow" href="{{route('admin.uniforms.index')}}"><img src="{{asset('public/admin/images/reset.png')}}" height="25"></a>
                        ...
                        <tr>
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="">
                                        <label class="toggle" for="myToggle{{$con->id}}">
                                            <input class="toggle__input" name="" onchange="toggleStatus(this)" data-update_url="{{route('admin.uniforms.update',$con->id)}}" {{$con->status?"checked":""}} type="checkbox" id="myToggle{{$con->id}}">
                            ...
                            <td style="width: 100px;">
                                <div class="table-action-info">
                                    ...
                                    <button onclick="edit(this)" data-name="{{ $con->name }}" data-isleague="{{ $con->isleague }}" data-update_url="{{ route('admin.uniforms.update', $con->id) }}" data-bs-toggle="modal" data-bs-target="#editConferences" class="edit-btn">
                                    ...
                                    <button type="button" class="btn  btn-xs" onclick="deletePost({{ $con->id }})">
                                        ...
                                        <form action="{{ route('admin.uniforms.destroy', $con->id) }}" method="POST" id="del-post-{{ $con->id }}" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        </a>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="lm-modal-form">
                    <h2>Add New Uniforms </h2>
                    <form action="{{ route('admin.uniforms.store') }}" method="POST" enctype="multipart/form-data" id="create-form">
                        @csrf
                        <input type="hidden" name="redirect_url" id="redirect_url" value="{{ route('admin.uniforms.index') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <ul class="lm-Status-list">
                                        <li>
                                            <div class="lm-radio">
                                                <input type="radio" value="1" id="edit-isleague_yes" name="isleague">
                                                <label for="edit-isleague_yes">
                                                    YES
                                                </label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="lm-radio">
                                                <input type="radio" value="0" id="edit-isleague_no" name="isleague">
                                                <label for="edit-isleague_no">
                                                    NO
                                                </label>
                                            </div>
                                        </li>
...
<script>
    ...
    function edit(ele) {
        ...
        $("#edit-isleague").val(ele.getAttribute("data-isleague"));

        if (parseInt(ele.getAttribute("data-isleague"))) {
            $("#edit-isleague_yes").attr("checked", "true");

        } else {
            $("#edit-isleague_no").attr("checked", "true");
