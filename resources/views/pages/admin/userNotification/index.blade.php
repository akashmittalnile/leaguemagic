                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <div class="table-action-info">
                                    ...
                                    <button onclick="edit(this)" data-subject="{{ $con->subject }}" data-created_at="{{ 'Notification sent on : '.date('d/m/Y - h:i a ',strtotime($con->created_at))  }}" data-object_type="{{ $con->object_type }}" data-notification="{{ $con->notification }}" data-bs-toggle="modal" data-bs-target="#editConferences" class="edit-btn">
                                        <img src="{{ asset('public/admin/images/view-icon.svg') }}">
                                    </button>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="lm-modal-form">
                    ...
                    <h2 class="alert-warning p-1"> <button class="btn" data-bs-dismiss="modal" aria-label="Close"> <img src="{{ asset('public/admin/images/back.png') }}" height="30"></button> View Notification Details </h2>
                    <form method="POST" enctype="multipart/form-data" id="edit-form">
                        ...
                        <div class="row">
                            <div class="col-md-12 p-2">
                                <p class="p-1 my-2 text-center rounded-pill alert h6 alert-success" id="edit-created_at"> </p>
